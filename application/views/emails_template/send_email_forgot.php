    ...
    <tr>
        ...
        <td valign="top" style="height:100%;margin:0 50px;padding:0 30px;width:100%;border-top:0;">
            ...
            <table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                <tr>
                    <td valign="middle" align="center" style="height:100%;margin:0;padding:5px;width:100%;border:0px;color:#fff;background-color:#d33c44;font-size:14px">
                        <p style="font-size:14px; margin:5;font-weight:100">Someone, hopefully you, has requested to reset the password for your nuamo account on <a style="color: #ffffee;" href="http://nuamo.com">http://nuamo.com</a>. </p>
                        <p style="font-size:14px; margin:5;font-weight:100">If you did not make this request, simply ignore this message and no further action will be taken.</p>
                        <p style="font-size:14px; margin:5;font-weight:100"> Otherwise, click the link below to complete the process. </p>
                        <a href="<?= base_url('auths/reset_password/{token_key}')?>" style="border-radius:5px;color:#333;background-color: #fff;border: none;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin:20px;font-weight:600" >CHANGE YOUR PASSWORD</a>
                        <p><small><i>This link expires in 24 hours ({token_exp}), but don't worry, you can always request a new one!</i></small></p>
                    </td>
                </tr>
                </tbody>
            </table>
