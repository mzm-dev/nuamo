                    ...
                    foreach ($members->result_array() as $member): ?>
                        <tr>
                            ...
                            <td class="col-md-1 text-center">
                                <?= '<i class="fa ' . ($member['is_active'] ? 'fa-check-circle' : 'fa-times-circle-o') . ' fa-lg text-danger"></i>';?>
                            </td>
                            <td class="col-md-2">
